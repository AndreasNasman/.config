...
vim.keymap.set('n', '<Leader>f', function () toggle_plugin('mini.files') end, { desc = 'Toggle MiniFiles' })
...
vim.keymap.set('n', '<Leader>w', '<C-w>', { desc = '[C]ontrol [W]indows with the leader key' })
