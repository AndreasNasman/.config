return {
    {
        ...
        config = function()
            ...
            vim.keymap.set('n', '<leader>se', function() run(file_browser.file_browser, { path = '%:p:h', select_buffer = true }) end, { desc = '[S]earch using Telescope File Browser with the [C]urrent file' })
